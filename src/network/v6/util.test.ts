...
async function test(): Promise<string[]> {
...

    {
        ...
        if (BITS !== (BigInt(0b11111111111111111111111111111111) << 96n)
            + (BigInt(0b11111111111111111111111111111111) << 64n)
            + (BigInt(0b11111111111111111111111111111111) << 32n)
...

    {
        ...
        for (const data of <{ in: bigint, out: bigint }[]>[
            ...
            { in: -1n, out: 0n },
            {
                in: (BigInt(0b01011100011101101010110111010000) << 96n)
                    + (BigInt(0b11010010110001111100011010000011) << 64n)
                    + (BigInt(0b00000101001010100001011111100001) << 32n)
                    + BigInt(0b11010101010101010101010101010101),
                out: (BigInt(0b10100011100010010101001000101111) << 96n)
                    + (BigInt(0b00101101001110000011100101111100) << 64n)
                    + (BigInt(0b11111010110101011110100000011110) << 32n)
                    + BigInt(0b00101010101010101010101010101010)
            },
        ]) {
